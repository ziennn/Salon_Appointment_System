...
if(isset($_POST['submit'])){
    ...
    try{
        ...
        $mail->SMTPAuth     = true;                                   
        $mail->Username     = 'navarro.c.bscs@gmail.com';                     //jhuncarlomacdon
        $mail->Password     = 'ziencute07';                           //wainasdztyhtramm
        $mail->SMTPSecure   = PHPMailer::ENCRYPTION_SMTPS;           
        $mail->Port         = 465;
        
        
            // RECIEPENTS
        $mail->setFrom('navarro.c.bscs@gmail.com', 'RHOSE SALON');//jhuncarlomacdon@gmail.com
